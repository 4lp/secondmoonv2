...
export default class Footer extends Component ***REMOVED***
	render()***REMOVED***
		return(
			<div>
				<div id="footer" style=***REMOVED***this.props.style***REMOVED***>
					<div className="row">
						...
						<div className="col-3 text-center">
							<h6>Shop Now</h6>
								***REMOVED***this.props.products.products.map((product) => (
									<div key=***REMOVED***product.id***REMOVED***>
										<Link to=***REMOVED***"/products/"+product.path***REMOVED***>***REMOVED***product.name***REMOVED***</Link>
									</div>
								))***REMOVED***
						</div>
						<div className="col-3 text-center">

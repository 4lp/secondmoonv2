			...
			***REMOVED***)
			.then(res => ***REMOVED***
				if (res.status === 200) ***REMOVED***
					return dispatch(***REMOVED***type: 'FETCH_BLOGCATEGORY', blogcategories: res.data***REMOVED***);
